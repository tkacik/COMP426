...
class Sections
{
	...
	public static function findByID($id){
		...
		$result = $mysqli->query("select Section.*, Department.abbrev, Course.course_num, TimeSlot.* from Section, Course, Department, Building, TimeSlot where Course.id = Section.course AND Department.id = Course.dept AND TimeSlot.id = Section.time_slot AND Section.location = Building.id AND Section.id = " . $id);
	    if ($result) {
